...
class Player
{
	...
	//Two maps of the turn direction
const static std::map<enum Direction, enum Direction> turn_right; //couldnt figure out how to implement
const static std::map<enum Direction, enum Direction> turn_left;
